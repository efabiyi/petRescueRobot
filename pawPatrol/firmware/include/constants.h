...
// DRIVE AND REFLECTANCE PINS AND CONSTANTS
...
//Claw
constexpr int CLAW_PIN = 27;
constexpr int X_PIN = 19;
constexpr int Y_PIN = 20;
constexpr int Z_PIN = 15;

constexpr int CLAW_CHAN = 4;
constexpr int Y_CHAN = 5;
constexpr int X_CHAN = 6;
constexpr int Z_CHAN = 7; 

//Hall Sensor
constexpr int HALL_SENSOR_PIN = 36;
