...
const int FWD_LEFT_PWM = 4;
const int BWD_LEFT_PWM = 5;
const int FWD_RIGHT_PWM = 13;
const int BWD_RIGHT_PWM = 14;
...
void drive() {
  ...
  if (!offLine) {
    float error = (leftReading * -1.0 + rightReading * 1.0) / 1000.0;
